...
# forked from https://mths.be/macos back in 2017
...
# Finder and native open/save panels: show hidden files by default
...
# Group windows by application in Mission Control (works better with Aerospace)
...
echo "Done. Please restart the system to apply all changes."
